...
with sync_playwright() as playwright:
    ...
    empty_course_icon = page.get_by_test_id('courses-list-empty-view-icon')
    expect(empty_course_icon).to_be_visible()

    course_empty_description = page.get_by_test_id('courses-list-empty-view-description-text')
